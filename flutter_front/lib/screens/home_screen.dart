...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _productsFuture = ProductService.getAllProducts(); // Backend থেকে লোড
  }
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  ...
                  ).then((_) => setState(() {})); // কার্ট থেকে ফিরলে রিফ্রেশ
                },
              ),
              FutureBuilder<int>(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 40), // নিচে একটু বেশি স্পেস
            ],
          ),
        ),
      ),
...
// Banner Carousel Widget (আগের মতোই রাখা হলো, কোনো চেঞ্জ নেই)
